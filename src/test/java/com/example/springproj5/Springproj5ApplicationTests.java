...
class Demo1ApplicationTests {
    ...
    String FIRESTORE_COLLECTION = "https://firestore.googleapis.com/v1/projects/projectspring-e6266/databases/(default)/documents/user/";
    ...
    void testingFirebase() throws JSONException {
        ...
        jsonObject.put("email", "zeynebnagiyeva2@gmail.com");
        ...
        assertEquals("Zeyneb", name.getString("stringValue"));
        assertEquals("Nagiyeva", surname.getString("stringValue"));
        assertEquals("1234567", phone.getString("stringValue"));
