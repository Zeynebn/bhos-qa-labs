...
class Springproj2ApplicationTests {
    ...
    @Test
    @DisplayName(" test to check the SSL of the URL is valid with the hosted certificate")
    ...
    @Test
    @DisplayName("  test to check the response JSON of the URL  is a list, and item parameters  is unique")
